 ...
 */
public class AssistentSearchEmployee extends javax.swing.JFrame {

    /**
     * Creates new form AssistentSearchEmployee
     */
    public AssistentSearchEmployee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(655, 382));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        HRAssistent ASearch = new HRAssistent();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssistentSearchEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssistentSearchEmployee().setVisible(true);
            }
        });
    }
